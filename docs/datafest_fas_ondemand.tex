...
It is probable that the package you need is already pre-installed and that you can import it in your notebooks with \texttt{import\ packagename}. If that is not the case, below are the steps to install R and Python packages .
