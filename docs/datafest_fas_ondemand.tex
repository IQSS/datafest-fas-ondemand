...
\hypertarget{how-to-launch-rstudio-jupyter-from-canvas}{%
\chapter*{How to launch RStudio / Jupyter from Canvas}\label{how-to-launch-rstudio-jupyter-from-canvas}}
\addcontentsline{toc}{chapter}{How to launch RStudio / Jupyter from Canvas}
...
\hypertarget{how-to-copy-codedata-from-the-shared-drive-to-your-home-directory}{%
\chapter{How to copy code/data from the shared drive to your home directory}\label{how-to-copy-codedata-from-the-shared-drive-to-your-home-directory}}

If your instructor has uploaded code and/or data to the shared drive (the \texttt{shared\_data} directory within your \texttt{Home} directory) then the first thing you should do before using these files is to copy them to your \texttt{Home} directory. These copies will serve as your own personal version of the files, which you can modify as you wish.
...
\hypertarget{how-to-download-codedata-to-your-personal-computer}{%
\chapter{How to download code/data to your personal computer}\label{how-to-download-codedata-to-your-personal-computer}}
