...
\item
  Copy the file(s) or directories you want from the ``shared\_data'' directory to your home directory: \texttt{cp\ -r\ shared\_data/\textless{}file-or-directory-you-want\textgreater{}/\ .}
\end{enumerate}
